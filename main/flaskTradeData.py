...
@app.route('/get_ratios/<comp_name>/<comp_code>', methods=['GET'])
def balance_sheet_provider(comp_name, comp_code):
    yahoo_finance_object = YahooFinancials(comp_code)
    balance_sheet_raw = yahoo_finance_object.get_financial_stmts('annual', 'balance')
    income_statement_raw = yahoo_finance_object.get_financial_stmts('annual', 'income')
    e_p_s = None
    pe_rat = None
    try:
    ...
    income_statement = income_statement_raw["incomeStatementHistory"][comp_code]

    company_data_provider_object = StockDataExtractor(comp_code,
                                                      comp_name,
                                                      balance_sheet,
                                                      income_statement,
                                                      e_p_s,
    ...
    comp_ratio_data_dict = json.dumps(company_data_provider_object.return_data_for_stock())
